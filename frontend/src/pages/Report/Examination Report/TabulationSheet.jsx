import { FaPrint, FaFilePdf, FaEye } from 'react-icons/fa';
  ...
  {exam.map((examItem) => (
    <option key={examItem.id} value={examItem.id}>
      ...
      <div className="flex justify-center mt-6">
        <button className="bg-[#13148b] text-white px-8 py-2 rounded font-medium hover:bg-[#0f0f78]">
          Show
        </button>
      </div>
        ...
        <table className="min-w-full text-center bg-white">
          ...
          <tbody>
            <tr className="text-sm">
              ...
              {/* <td className="border px-3 py-2">Sc</td> */}
              <td className="border px-3 py-2">RSM-00057</td>
              <td className="border px-3 py-2">106</td>
              <td className="border px-3 py-2">0/0</td>
              <td className="border px-3 py-2">-</td>
              <td className="border px-3 py-2">
                <button className="flex items-center gap-2 border px-4 py-1 rounded hover:bg-gray-100">
                  <FaEye /> Pass
                </button>
              </td>
            </tr>

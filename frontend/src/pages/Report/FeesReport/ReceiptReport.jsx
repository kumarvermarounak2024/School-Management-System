...
<div>
  <label className="block text-sm font-medium text-gray-700 mb-1">Payment Via<span className="text-red-500">*</span></label>
  <select
    className="w-full border border-[#C0D5FF] rounded p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  />
                ...
                <div className='border-b-2 border-[#143781] mb-6'>
                    <div>
                        <h3 className='text-xl font-semibold text-[#143781]'>Receipt Report </h3>
                    </div>
                </div>
                    ...
                    <table className="min-w-full border border-gray-300">
                        <thead>
                            <tr className="bg-blue-100">
                                ...
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Date</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Class</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Collect By</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Payment Via</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Fees Type</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Amount</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Discount</th>
                                <th className="border border-gray-400 px-4 py-2 text-left text-sm font-semibold">Fine</th>
  ...
  {currentItems.length === 0 ? (
    <tr>
      <td colSpan="13" className="border border-gray-400 px-4 py-2 text-center text-gray-600">
        No data found.
      </td>
    </tr>
  ) : (
    currentItems.map((item, index) => (
      <tr key={index} className="hover:bg-gray-50">
        ...
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.studentName || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.registrationNo || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.rollNo || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.date ? new Date(item.date).toLocaleDateString() : "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.className || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.collectedBy || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.paymentVia || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.feesType || "-"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.amount || "0"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.discount || "0"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.fine || "0"}</td>
        <td className="border border-gray-400 px-4 py-2 text-sm">{item.total || "0"}</td>
      </tr>
    ))
  )}
</tbody>

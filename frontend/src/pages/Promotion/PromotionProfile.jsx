...
import { Mail, Phone, Home, User, ArrowLeft } from "lucide-react";
   ...
   const PromotionProfile = ({ student: studentFromProp, onBack }) => {
 ...
 const fetchUploadedDocs = async (admissionId) => {
  try {
    ...
    const documents = res.data.document || (res.data.admission && res.data.admission.document) || [];
  ...
  <div className="p-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-lg">
      ...
      <p>
        ...
        <span className="font-semibold text-gray-700">{student.religion || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Blood Group: </span>
        <span className="font-semibold text-gray-700">{student.bloodGroup || "-"}</span>
      </p>
      <p>
      ...
      <p>
        ...
        <span className="font-semibold text-gray-700">{student.permanentAddress || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Mother Tongue: </span>
        <span className="font-semibold text-gray-700">{student.motherTongue || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Category: </span>
        <span className="font-semibold text-gray-700">{student.category || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Caste: </span>
        <span className="font-semibold text-gray-700">{student.caste || "-"}</span>
      </p>
  ...
  <div className="p-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-lg text-gray-800">
      <p>
        <span className="font-bold text-blue-900">Father Name: </span>
        <span className="font-semibold">{student.father_name || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Mother Name: </span>
        <span className="font-semibold">{student.mother_name || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Relation: </span>
        <span className="font-semibold">{student.relation || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Occupation: </span>
        <span className="font-semibold">{student.occupation || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Income: </span>
        <span className="font-semibold">{student.income || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Education: </span>
        <span className="font-semibold">{student.education || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Guardian Mobile No: </span>
        <span className="font-semibold">{student.mobile_no_guardian || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">Guardian Email: </span>
        <span className="font-semibold">{student.email_guardian || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">City: </span>
        <span className="font-semibold">{student.guardian_city || "-"}</span>
      </p>
      <p>
        <span className="font-bold text-blue-900">State: </span>
        <span className="font-semibold">{student.guardian_state || "-"}</span>
      </p>
      <p className="md:col-span-2">
        <span className="font-bold text-blue-900">Address: </span>
        <span className="font-semibold">{student.guardian_address || "-"}</span>
      </p>
    </div>
  </div>
)}
                  ...
                  {item === "Book Issue" && (
                    <p className="text-gray-600 py-2">
                      Book issue details will be shown here.
                    </p>
                  )}
                  {item === "Exam Result" && (
                    <p className="text-gray-600 py-2">
